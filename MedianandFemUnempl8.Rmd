...
Figure 2 shows that in most countries of our dataset, HIV/AIDS incidence rates decreased between 2000 and 2012 (see Figure 2). The blue line in Figure 2 is however only representing the general downward trend of HIV/AIDS incidence over time in our sample. The black dots above the blue line show that the dispersion of the observations around the trend. As it can be seen, there are severe outliers that show a strong increase in incidence rate there are still some outliers to this trend (mostly .
