...
hist(HighInc$Incidence, xlab="Dummy Coding: Incidence above the Median", main="Figure X: Dummy Variable")
```


```{r, echo=FALSE}
HighInc$lIncidence <- log(HighInc$Incidence)
hist(HighInc$lIncidence, xlab="Dummy Coding: Log Incidence above the Median", main="Figure XX: Dummy Variable")
...
#### MODEL 1.3.3 - Calculating predicted probabilities for Quintiles of Female Unemployment for the Scenario Malawi

# Calculating the means for Malawi
summary(Malawi)

# Fixing the Malawi Scenario, letting Quintiles of Female Unemployment vary
...
#### MODEL 1.3.4 - Calculating predicted probabilities for Quintiles of Female Unemployment for the Scenario Botswana

# Calculating the means for Botswana
summary(Botswana)

# Fixing the Botswana Scenario, letting Quintiles of Female Unemployment vary
...
```{r, echo=FALSE, message=FALSE, error=FALSE, fig.width=19, fig.height=12, dpi=150}
# Creating a joint plot with the predicted probabilities for Share of Female Unemployment
par(mfrow=c(2,2))
