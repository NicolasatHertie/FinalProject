...
The link between health, education and gender was extensively researched by Sachs and Dupas. While Sachs provides several examples of the interaction of these variables at the macro level, Dupas successfully tested the linkage between female education and health by conducting randomized control trials in Kenya. Among the findings of her research, it is worth mentioning the significant effect of risk reduction campaigns on HIV prevention. These campaigns were specifically target at girls. (REF)
...
Who used the data before? how does the data look like? in which format can one access the data?
