...
```{r, echo=FALSE, include=FALSE}
# MODEL 1 - Running a general logistic regression using all independent variables
Test <- lm(DDif ~ lGDP + lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lUnemploym + lPrimary + lHCexpendpc + Inverse + lFemSchool + lLifeExpect + lDPT + lMeasles,
          data=Merged)
summary(Test)
acf(Test)

FE <- lm(DDif ~ lGDP + lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lUnemploym + lPrimary + lHCexpendpc + Inverse + lFemSchool + lLifeExpect + lDPT + lMeasles + factor(iso2c) -1,
          data=Merged)
summary(FE)

library(plm)
FEw <- plm(DDif ~ lGDP + lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lUnemploym + lPrimary + lHCexpendpc + Inverse + lFemSchool + lLifeExpect + lDPT + lMeasles,
          data=Merged, model="within")
summary(FEw)

RE <- plm(DDif ~ lGDP + lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lUnemploym + lPrimary + lHCexpendpc + Inverse + lFemSchool + lLifeExpect + lDPT + lMeasles,
          data=Merged, model="random")
