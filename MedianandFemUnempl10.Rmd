...
Reducing HIV/AIDS incidence is an important aim of the MDGs. Target 6.A of the MDGs specifies that countries should "have halted by 2015 and begun to reverse the spread of HIV/AIDS" [@UN2014]. In most regions of the world this goal has been fulfilled: new HIV infections declined and the overall number of new HIV/AIDS infections per 100 adults (15-49 years old) decreased by 44 per cent between 2001 and 2012 [@UN2014]. However, this trend cannot be observed in all 189 member states of the United Nations. On the contrary, HIV/AIDS prevalence has even increased in some countries. 
...
WDI have been used in a wide range of fields and HIV/AIDS research is not an exception. For examples of relevant literature that also make use of WDI please see Haacker, Talbott and Kalemli [@Haacker2002]  [@Talbott2007]  [@Kalemli2011]. A list of all WDI indicators used for this research can be found in the Appendix.


## UNAIDS Dataset

The UNAIDS dataset is available for free at the UNAIDS ([website](http://www.unaids.org/l)) and it has been put together by UNAIDS during the research for the UNAIDS GAP Report 2014 [@UNAIDS2014]. It provides data on HIV/AIDS incidence, prevalence and HIV-related deaths for the period 1990-2013. The dataset aditionally provides uncertainty bounds (low and high estimated) for most of the variables. Further, there is information for all UN member states and there is also regionally aggregated data. Some of the indicators such as prevalence and incidence are disaggregated for the different demographic groups, including data for adults, youth and children, male and female. 
...
Model 2 looks into more detail to the countries where HIV incidence rates are above the median and uses the same independent variables as model one. The dependent variable in model 2 is the logarithm of HIV incidences rates. In this case, given that the dependent variable is not a binomial variable but a contiuous one, model two is estimated using pooled OLS. 
...
In order to deal with the skewness of this variable, a dummy variable, differentiating between countries with a high HIV incidence and countries with a low HIV incidence was created for the first empirical model. 
...
For the second empirical model the sample was reduced and focused only on countries with a high HIV/AIDS incidence rate in order to explore whether the determinants identified in Model 1 hold true when zooming in on the more problematic cases.
...
Scatterplots were created for all independent variables by the levels of Dahlgrehn's model, in order to see whether further relevant variables are skewed and to broader explore the relationship of the selected determinants for each level (see Appendix). Due to high skewness in most of the variables and to ensure a better comparability of the variable units, all but one of the independent variables in the sample were logged.
...
Figure 10 shows the school enrollment rates of females per country over time. The descriptive statistics for female school enrollment in the selected countries are in general in line with our intuition. Malawi, one of the "best" practices has a very high female school enrollment rate. It showed a steep increase in female school enrollment between 2007 and 2012. Botswana the other "best" practice had a low but stable female school enrollment rate between 2000 and 2009 - after 2009 there was no data available for female school enrollment in Botswana. For Uganda, one of the "bad" cases, the rate of females enrolled in schools showed a general decreasing tendency with some backlashes for Uganda. For the other "bad" example Lesotho, the female school enrollment rate also decreased over time but stagnated between 2009 and 2012. 

**Female School Enrollment in Selected Countries**

![Figure10](fig10.png)

Figure 11 shows the female unemployment rate compared to total unemployment rate per country over time. The descriptive statistics are generally not reflecting our intuition very well. Malawi, one of the "best" practices had a low and very stable female unemployment rate compared to total unemployment rate between 2000 and 2012. Botswana the other "best" practice had a higher (around 3%) slightly increasing female unemployment rate compared to the total unemployment rate between 2000 and 20012. Uganda, one of the "bad" cases, a low and very stable female unemployment rate compared to total unemployment rate is observed over the 12 years. For the other "bad" example Lesotho, a very highf emale unemployment rate compared to total unemployment rate was observed until 2005, after that the rate decreased sharply until 2008 and than flactuated around 3 to 4 percent between 2008 and 2012.
...
plot(Uganda1.out, xlab="vvvv", ylab="hhhh")
...
Provided the special interest of this paper on the social and community networks level of the rainbow model, this section will mostly focus on the findings regarding the impact of female school enrollment and the differente of female to total unemployment on HIV incidence rates. As it was mentioned above, the interest in this particular level of Dahlgren and Whitehead's model is explained by the insufficient amount of research on the significance of such factors in explaining disease specific determinants of health. Furthermore, female schoole enrollment and the difference between female and total unemploymentis used in this paper to operationalize the social and community network factors. 
...
These findings cast doubts on the general applicability of Dahlgrehn and Whitehead [@Dahlgren] model to specific diseases like HIV/AIDS. 
...
A limitation specific to Model 1 is that the dummy variable used in this paper (differentiating between countries with an HIV/AIDS incidence rates above and below the median) is not the most accurate variable to measure progress in the achievement of Target 6.A of the MDGs ("have halted by 2015 and begun to reverse the spread of HIV/AIDS") [@UN2014]. A plain dummy variable on whether MDG 6.a was achieved or not is however not suitable for identifying the specific determinants of HIV/AIDS at the country level as it is not differentiating between the relative size of the effect (an increase from 0,001 to 0,002 would be equally bad as a change from 0,1 to 0,3). Future research could however try to solve this problem for example by adding weights or ratios, which would facilitate a clearer explanation of why some countries will fail to achieve MDG 6.a. 
