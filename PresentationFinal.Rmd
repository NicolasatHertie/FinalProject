...
## Selecting interesting Cases for Changes in HIV/AIDS Incidence
![Figureb](figb.png)
...
# Linear pooled OLS regression with robust standard errors
Variables <- c("Constant", "GDP per capita", "Rural Population", "CO2 Emissions", "Healthcare Expenditure", "Water Access", "Sanitation Access", "Life Expectancy", "DPT Immunisation", "Measles Immunisation", "Female School Enrollment", "Female Unemployment")
