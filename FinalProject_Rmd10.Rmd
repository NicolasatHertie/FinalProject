...
Merged$Inverse <- Merged$FemUnempl
...
Merged$QInverse[Merged$Inverse>2.53] <-1
Merged$QInverse[Merged$Inverse<2.53 & Merged$Inverse>=2.01] <-2
Merged$QInverse[Merged$Inverse<2.01 & Merged$Inverse>=1.46] <-3
Merged$QInverse[Merged$Inverse<1.46] <-4
...
Imputed.out <- amelia(Merged, m = 5, ts = "year", cs = "iso2c", idvars = "country", ords= c("QFemSchool", "Dummy", "QInverse","DDif"))
