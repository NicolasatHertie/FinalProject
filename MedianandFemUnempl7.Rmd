...
It can be concluded, that only for the variables Share of Rural Population, CO2 Emissions per capita, Life Expectancy and Female School Enrollment *ceteris paribus* statistically significant effects were found at the 95 percent confidence level in both regression models. The majority of the variables, namely GDP per capita, Healthcare Expenditure, Access to Water, Access to Sanitation, Immunisation against DPT, Immunisation against Measles and Share of Female Unemployment were however not statistically significant across both model specifications.
This finding casts doubts on the general applicability of the model on health determinants of Dahlgrehn and Whitehead [@Dahlgren] to specific diseases like HIV/AIDS. 

Further, the general importance of social and community networks for determining HIV/AIDS incidence can not be fully confirmed by the findings of this paper. As mentioned before, Share of Female Unemployment is only statistically significant in Model 2 and the direction of the effect of Female School Enrollment changes across the different model specifications. Nevertheless, Female School Enrollment showed a strong statistical significance across both models and can therefore be assumed to be an important even if potentially ambiguous determinant for HIV/AIDS incidence.
...
A specific limitation of Model 1 is that the dummy variable used in this paper (differentiating between countries with an HIV/AIDS Incidence above and below the median) is not the most accurate variable in terms of measuring whether Target 6.A of the MDGs ("have halted by 2015 and begun to reverse the spread of HIV/AIDS" [@UN2014] has been fulfilled until 2012. A plain dummy variable on whether MDG 6.a was fulfilled or not is however not suitable for identifying the specific determinants of HIV/AIDS at the country level as it is not differentiating between the relative size of the effect (an increase from 0,001 to 0,002 would be equally bad as a change from 0,1 to 0,3). Future research could however try to solve this problem for example by adding weights or ratios and than being able to establish a more direct link between the determinants for fulfilling MDG 6.a. 

A further limitation of Model 2 is that the dependent variable (logged HIV/AIDS incidence) for the sample of countries with a higher HIV/AIDS incidence is still not perfectly normally distributed after the log transformation. 
