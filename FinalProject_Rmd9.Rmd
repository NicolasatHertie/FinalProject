...
```{r, echo=FALSE, results="asis", error=FALSE}
#### SAVING THE REGRESSION OUTPUTS WITH KABLE
# Regression Results of Logistic Regression
#stargazer(L1.out, title="Model 1 - Logistic Regression Results including all independent variables", type="latex",  font#.size = "scriptsize")
