...
ggsave("fig11.png", width=7, height=3, dpi=100)
...
Merged$Dummy <- as.numeric(Merged$Incidence<=0.3493)
...
Imputed.out <- amelia(Merged, m = 5, ts = "year", cs = "iso2c", idvars = "country", ords= c("QFemSchool", "QInverse", "Dummy"))
...
Model1.out <- zelig(Dummy ~ lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lLifeExpect + lDPT + lMeasles + lFemSchool, data = Imputed.out, model = "logit")
...
Model2.out <- zelig(Dummy ~ lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lLifeExpect + lDPT + lMeasles + QFemSchool, data = Imputed.out, model = "logit")
...
b.out <- zelig(lIncidence ~ lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lLifeExpect + lDPT + lMeasles + lFemSchool, data = Imputed2.out, model = "ls")
 
summary(b.out)
 
# Estimating with robust standard errors
 
c.out <- zelig(lIncidence ~ lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lLifeExpect + lDPT + lMeasles + lFemSchool, data = Imputed2.out, model = "ls")
 
summary(c.out)
 
# Estimating the model with fixed effects
 
d.out <- zelig(lIncidence ~ lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lLifeExpect + lDPT + lMeasles + lFemSchool + as.factor(country), data = Imputed2.out, model = "ls")
 
summary(d.out)
 
# Estimating the model with fixed effects and robust standard errors
 
e.out <- zelig(lIncidence ~ lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lLifeExpect + lDPT + lMeasles + lFemSchool + as.factor(country), data = Imputed2.out, model = "ls", robust=TRUE)
