...
# Creating Variable Share of Female Unemployment compared to Total Unemployment
...
If you are coming from one of the countries that are grey in the map and you are wondering, *"Is HIV not a problem in my country?"* Well, it might be! The grey countries are actually those countries for which our dataset was insufficient. 

# REDUCING HIV FIGHTS POVERTY

Experts in the field of poverty reduction designed a list of goals that would help to reduce poverty across the world. These goals are called the Millenium Development Goals (MDGs) and the deadline to reach these goals is only some months away (September 2015). Halting and reversing the spread of HIV is one of these goals (MGD 6 - Target A). The inclusion of HIV control as one of the MDGs reflects that besides saving and improving people's lives, reducing HIV helps to fight poverty. 

Inspired by the puzzling question of why some countries failed to reach MDG 6, we decided to embark ourselves in this research.
...
To fill this gap, we started by identifiying a model of general determinants of health that we could use to test for disease-specific determinants of health. We chose Dahlgren and Whitehead's model because it provides a simple yet comprehensive framework to identify variables. According to this model, a wide range of factors influence our health, such as general socioeconomic factors, working and living conditions, social and community networks and individual factors (like smoking or drinking alcohol).
...
While the (limited) literature on specific determinants of HIV mostly focused on socioeconomic factors and individual factors, there are not so many papers looking at the influence of social and community networks. This is why we decided to explore social and community factors and see whether they are important for explaining the incidence of HIV/AIDS at the country level. For understanding the importance of social and community networks, we were especially interested in the impact of female school enrollment and female participation in the labour market. We assume, that females who are highly educated and who participate in the labour market are better informed about the risks of diseases like HIV/AIDS and are more self-confident in negotiating for safer sex.

# CASE STUDY SELECTION

We were particularly interested in looking at some case studies to take a closer look at the relation between our selected variables. To choose the case studies we looked at the evolution of HIV incidence across time and selected the countries where incidence either increased or strongly decreased over time. From these sampled countries, we took 2 best practices (Botswana and Malawi, green lines) and two bad practices (Lesotho and Uganda, red lines).
...
```{r, results='asis', echo=FALSE, error=FALSE, message=FALSE}
...
suppressWarnings(print(FemSchool))
```


- We were interested in looking at the impact of two variables on HIV/AIDS incidence rates. The first variable was female school enrollment. Early education represents an excellent opportunity to conduct HIV/AIDS preventation campaigns before children become sexually active. Given that girls are more often negotiating for protected sex, we looked at the impact of female school enrollment on HIV/AIDS incidence rates. We expected that this variable would be significant and have a negative impact on incidence, which means that higher female school enrollment would reduce HIV/AIDS incidence. The data supported this hypothesis.


**Female Unemployment compared to Total Unemployment - Case Studies**

```{r, results='asis', echo=FALSE, error=FALSE, message=FALSE}
ShFemUnempl <- ggplot(data=CaseStudies, aes(x=year, y=ShFemUnempl, group=country, color=country, shape=country))  + geom_line () + geom_point()+ ylab( "Female Unemployment compared to Total Unemployment") + xlab("Year")

suppressWarnings(print(ShFemUnempl))
```


- The second variable that we explore was the difference between female unemployment and total unemployment. We expected that a high rate of female employment to total unemployment would describe a society where women have relatively less power than men and this would mean that men could more easily bargain for unprotected sex. As a consequence, one would expect that a higher difference in female to total unemployment would be associated with higher HIV/AIDS incidence rates. This hypothesis was not supported by out findings, according to which the difference between female and total unemployment has no impact on HIV/AIDS incidence rates.
...
Demo <- plyr::rename(Demo, c("ShFemUnempl" = "Female Unemployment Rate 2 (Female Unemployment compared to Total Unemployment)"))
Demo <- plyr::rename(Demo, c("Incidence" = "HIV/AIDS Incidence Rate"))
...
We were particularly interested in looking at the evolution of HIV/AIDS incidence rates (y axis) in relation to the evolution of female school enrollment (x axis). As you can see, while female school enrollment increases, HIV/AIDS incidence rates decrease.
...
1. **INVEST IN GIRLS EDUCATION:** If female school enrollment is a significant determinant of HIV/AIDS, investing in female education is not only a good investment because it will improve the skills of women and increase their opportunities to get a job but also because it will make the population healthier thus reducing the costs of the health system.

2. **FURTHER EXPLORE THE LINK BETWEEN FEMALE LABOUR PARTICIPATION AND HIV/AIDS INCIDENCE:** When looking at the difference between female and total unemployment, we realised that this indicator is not exactly portraying the variable that we wanted to analyze, namely female labour participation. It would be therefore interesting to test whether this variable is a good determinant of HIV/AIDS before reaching any conclusion.

3. **LOOK AT MORE DETERMINANTS OF SPECIFIC DISEASES:** We realised that there is a gap in the literature exploring disease specific determinants of health regarding the impact of social and community level factors. It would be interesting to evaluate the determinants of other diseases and see whether these coincide with the determinants of HIV/AIDS.


Thank you for visiting our website. 
If you have any questions, please contact us at m.moellenkamp@mpp.hertie-school.org or n.rosemberg@mpp.hertie-school.org