...
Experts in the field of povery reduction designed a list of strategies to reduce global poverty and set a list of 8 goals in order to combat poverty. These goals are called the Millenium Development Goals (MDGs) and the deadline to reach this goal is only some months away (September 2015). Halting and reversing the spread of HIV is one of these goals (MGD 6 - Target b). The inclusing of HIV control as one of the MDGs reflects that besides making people healthier and happier, reducing HIV helps to fight poverty. 
...
Inspired by the puzzling question of why some countries failed to reach MDG6, we embarked this research.

# HOW DID WE CONTRIBUTE TO THE EXISTING RESEARCH?

The first part of the research explored the existing literature on determinants of health and found that there is a gap in the literature in the relevance of determinants of health in explaining the incidence and prevalence of specific diseases.

To fill this gap, we started by identifiying a model of general determinants of health that we could test for a specific disease. We chose Dahlgren and Whitehead's model because it provides a simple yet comprehensive framework to identify variables. According to this model, there are a wide range of factors that influence our health, such as general socioeconomic factors, working and living conditions, social and community networks and individual factors (like smoking or drinking alcohol).

! [Dahlgren and Whitehead]("Dahlgren.png")

While the (limited) literature on specific determinants of HIV mostly focused on socioeconomic factors and individual factors. there are not so many papers looking at the influence of social and community networks. This is why we decided to explore social and community factors and see whether they are significant to explain the incidence of HIV.
