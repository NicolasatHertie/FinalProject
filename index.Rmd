...
In fact, we are not the only ones looking at this issue. The global community has come together to tackle the world's most pressing issues and HIV/AIDS is one of them. These global challenges are under the umbrella of the Millenium Development Goals (MDGs). The MDGs represent the agenda for development agencies and policy makers in low- and middle- income countries and serve as a guideline for the prioritazion of interventions to fight poverty. For more information on the MDGs please refer to the following links:
